...
Функтор $F$ називається \textbf{вільною (faithful)}, якщо ця звужена функція -- ін'єктивна для всіх об'єктів $x,y$ категорії $C$.\\
...
\begin{definition}
\textbf{Конкретною категорією} називають пару $(C,F)$, де $C$ -- категорія та $F \colon C \to \Set$ -- вільний функтор.
\end{definition}
...
\begin{theorem}
Кожний вільний функтор відбиває комутативність діаграм.
\end{theorem}

\begin{proof}
Нехай $F \colon C \to D$ -- вільний (точний) функтор. Нехай $\displaystyle\prod F(\alpha_i) = \prod F(\beta_i)$. Тоді\\
